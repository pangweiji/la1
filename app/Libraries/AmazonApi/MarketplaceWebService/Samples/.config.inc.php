<?php
    ...
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', $userToken['AWS_ACCESS_KEY_ID']);
    define('AWS_SECRET_ACCESS_KEY', $userToken['AWS_SECRET_ACCESS_KEY']);
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', $userToken['APPLICATION_NAME']);
    define('APPLICATION_VERSION', $userToken['APPLICATION_VERSION']);
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', $userToken['MERCHANT_ID']);
    define ('MARKETPLACE_ID', $userToken['MARKETPLACE_ID']);
    ...
    ***********************************************************************/   
    set_include_path(app_path('Libraries/AmazonApi'));    

<?php
    ...
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAJ7YKZOX4TXDWPGXA');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'APJTSFXKG7BYQ');
    ...
    ***********************************************************************/   
    set_include_path(get_include_path() . PATH_SEPARATOR . WEB_PATH . "crontab/");    

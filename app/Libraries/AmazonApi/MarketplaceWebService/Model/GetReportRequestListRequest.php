...
class MarketplaceWebService_Model_GetReportRequestListRequest extends MarketplaceWebService_Model
{
    ...
    public function setReportRequestIdList($value) 
    {
    	...
    	$requestIdList->setId($value['Id']);
        $this->fields['ReportRequestIdList']['FieldValue'] = $requestIdList;
        return;
    }
    ...
    public function setReportTypeList($value) 
    {
    	...
    	$marketTypeList = new MarketplaceWebService_Model_TypeList();
    	$marketTypeList->setType($value['Type']);
    	$this->fields['MarketplaceIdList']['FieldValue'] = $marketTypeList;
